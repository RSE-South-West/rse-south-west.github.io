...
<table class="table agenda">
  ...
  <tr>
    <td>[How can Universities / or Scientific centres support RSEs to deliver and share better research software?](https://padlet.com/pollyeccleston1/rse-sw-how-can-universities-or-scientific-centres-support-rs-eii7qg000a3hxz1z)<br>
      ...
      <br>
      Resources: [Padlet](Polly_Eccleston_Universities_support_RSEs.pdf){target=_blank}<br>
      Video: [Discussion](https://www.youtube.com/watch?v=BOqwyZHb1Q4&t=4326s)
  <tr>
    <th rowspan="4">11:50
    <th>Lightning talks (5 minutes)
  <tr>
    <td>[Research IT Facility at the University of Bristol](meetings/2025-06-23-bristol/talks/Serena_Cooper_Research_IT_Facility_at_UoB.pdf){target=_blank}<br>
      <em>Serena Cooper</em>
      <details>
        <summary>Abstract</summary>
  ...
  <tr>
    <td>[Developing & Deploying Conceptual Design Tools for Factory Planning](meetings/2025-06-23-bristol/talks/Lewis_Gilbert_Developing_Deploying_Conceptual_Design_Tools_for_Factory_Planning.pdf){target=_blank}<br>
      <em>Lewis Gilbert</em>
      <details>
        <summary>Abstract</summary>
  ...
  <tr>
    <td>[The Isambard supercomputers](meetings/2025-06-23-bristol/talks/Matt_Williams_The_Isambard_supercomputers.pdf{target=_blank})<br>
      <em>Matt Williams</em>
      <details>
        <summary>Abstract</summary>
  ...
  <tr>
    <td>[Mapping the March: an RSE's adventures in time and space](meetings/2025-06-23-bristol/talks/Mike_Jones_Mapping_the_March_an_RSE's_adventures_in_time_and_space.pdf){target=_blank}<br>
      <em>Mike Jones</em>
      <details>
        <summary>Abstract</summary>
  ...
  <tr>
    ...
    <th>Lightning talks (5 minutes)
  <tr>
    <td>[How do you host translated content within a Django application?](meetings/2025-06-23-bristol/talks/Benjamin_O'Driscoll_How_do_you_host_translated_content_within_a_Django_application.pdf){target=_blank}<br>
  ...
  <tr>
    <td>[Support for the Python array API standard in SciPy](meetings/2025-06-23-bristol/talks/Jake_Bowhay_Support_for_the_Python_array_API_standard_in_SciPy.pdf){target=_blank}<br>
      <em>Jake Bowhay</em>
      <details>
        <summary>Abstract</summary>
